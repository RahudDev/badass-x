    ...
    <div>
      ...
      <div>
        <div>
          ...
          {loadingMessage &&  <div className='loading-container-google align-items-center justify-content-center min-vh-100'>
          <div className="spinner-google"></div>
          <div className="loading-text-google">Fetching pollfish...</div>
          </div> }
        </div>
      </div>
      <div id='surveyContainer'>
        <div id="survey">
          {surveyURL && <iframe title='survey' id="pollfishSurveyFrame" className= "cpx-research-frame" frameBorder="0" name="pollfishSurveyFrame" seamless="seamless" src={surveyURL}></iframe>}
        </div>
      </div>
    </div>
  );
