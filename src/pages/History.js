        ...
        <div className="table-responsive">
          <table className="table table-hover table-bordered">
            ...
            displayedTransactions.map((transaction, index) => (
             <tr key={index} style={{ height: '60px' }}> {/* Add height to create vertical spacing */}
            <td style={{ padding: '20px', textAlign: 'center' }}>{renderOfferIcon(transaction.nameOffer)}</td>
              <td style={{ padding: '20px', textAlign: 'center' }}>{transaction.description}</td>
            <td style={{ padding: '20px', textAlign: 'center' }}>{formatPoints(transaction.points, transaction.nameOffer)}</td>
            <td style={{ padding: '20px', textAlign: 'center' }}>{transaction.transactionID}</td>
             <td style={{ padding: '20px', textAlign: 'center' }}>{new Date(transaction.date).toLocaleString()}</td>
            </tr>
            ))
            ) : (
             <tr>
