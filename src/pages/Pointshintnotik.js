...
const Pointshintnotik = ({ showModal, handleClose }) => {
  ...
  return (
    <Modal show={showModal} onHide={handleClose}>
      <Modal.Header className='point-hint-notik' closeButton>
        <Modal.Title><strong>Boost Your Earnings with Notik!</strong></Modal.Title>
      </Modal.Header>
      <Modal.Body className='point-hint-notik'>
        <p>
      ...
      <Modal.Footer className="d-flex justify-content-center point-hint-notik">
        <Button
          variant="primary"
