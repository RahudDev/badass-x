...
import { faGlobe, faChevronDown } from '@fortawesome/free-solid-svg-icons'; // For Globe icon
...
const OffersPagebitlabs = ( ) => {
  ...
  {offers.map((offer) => (
    <Col key={offer.id} className="mb-3 d-flex justify-content-center">
      <Card className="shadow-lg offer-card" style={{ borderRadius: '10px', padding: '10px', width: '200px', margin: '0 10px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
        <Card.Img
          ...
          alt={offer.anchor}
          style={{ maxHeight: '200px', maxWidth: '200px', objectFit: 'cover', borderRadius: '8px', margin: '0 auto' }}
        />
        <Card.Body style={{ display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
          ...
          <div className="d-flex justify-content-center mt-auto">
            <Button variant="primary" onClick={() => showOfferDetails(offer)}>
              Start Offer
            </Button>
          </div>
        </Card.Body>
